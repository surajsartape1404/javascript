...
let e4 = info.replace("javascript", "python")
console.log(e4)
...
let city7 = "pandharpur"
let q4 = city7.endsWith("r")
let q5 = city7.endsWith("pur")
let q6 = city7.endsWith("R")
...
// trimStart()
let q8 = city8.trimStart()
console.log(q8)
console.log(q8.length)

// trimEnd()
let q9 = city8.trimEnd()
console.log(q9.length)

// toUpperCase()

let city9 = "wardha"
let q10 = city9.toUpperCase()
console.log(q10)

// toLowerCase()
let city10 = "NAGPUR"
let q11 = city10.toLowerCase()
console.log(q11)

// Split()

let email = "surajsartape1404@gmail.com"
let q12 = email.split('@')
console.log(q12)
console.log(q12.join("@"))

let names3 = "surajsartape"
let q13 = names3.split('a')
console.log(q13)
