...
let names3 = ["chinmay", "shirish", "ram", "sham", "vaibhav", "sumit"]
e = names3.slice(2)
console.log(e)
// console.log(names3.slice(1, 5))
// console.log(names3.slice(1, 4))
// console.log(names3.slice(-5))
// console.log(names3.slice(-5, -1))
// console.log(names3.slice(-5, 4))
// console.log(names3.slice(-1, -5))
...
// retrive 
let names4 = ["suraj", "sartape", 7083646111, 25, 73]
console.log(names4)
console.log(names4[0])
...
let names6 = ["suraj", "sartape", 7083646111, 25, 73]
names6.pop()
names6.shift()