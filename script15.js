...
let withdraw = transactions.filter(function (el, index, arr) {
    return el < 0
})
...
// find()
//              0  1  2  3  4  5 6  7 8
let MarksN = [12, 88, 55, 66, 77, 12, 3, 45, 55]
let q6 = MarksN.filter(function (el) {
    return el > 50
})
console.log(q6)

// only first occurrence
let q7 = MarksN.find(function (el) {
    return el > 50
})
console.log(q7)

let q8 = MarksN.findIndex(function (el) {
    return el > 50
})
console.log(q8)
